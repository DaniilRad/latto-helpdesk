    ...
    <>
      ...
      <div style={{ display: "flex", gap: 10, marginBottom: 14, flexWrap: "wrap" }}>
        <Input
          ...
          icon={<Search size={16} />}
          value={q}
          onChange={(e) => clearParamsOn(setQ)(e.target.value)}
          wrapStyle={{ width: 290 }}
        />
        <Select
          value={type}
          onChange={(e) => clearParamsOn(setType)(e.target.value)}
          style={{ width: 160 }}
      ...
      {filtered.length === 0 ? (
        <EmptyState
          ...
          text="No devices match. Adjust the filters or add one."
          action={
        ...
        <TableCard>
          <thead>
            <tr>
              ...
              <SortableTh k="model" sort={sort}>
                Model
              </SortableTh>
              <SortableTh k="serial" sort={sort}>
                Serial
              </SortableTh>
              <SortableTh k="assigned" sort={sort}>
                Assigned to
              </SortableTh>
            ...
            {sort.sorted.map((d) => {
              ...
              return (
                <HoverRow key={d.id} onClick={() => nav(`/devices/${d.id}`)}>
                  ...
                  <td style={tdStyle}>
                    <Badge tone={s.tone} dot pulse={d.status === "repair"}>
                      {s.label}
                    </Badge>
                  </td>
                  ...
                  <td
                    style={{
                      ...
                      color: d.assignedTo ? "var(--text-1)" : "var(--text-3)",
                    }}
                  >

    ...
    <>
      ...
      {reservations.length === 0 ? (
        <EmptyState
          ...
          text="Nothing reserved. The spare gear is all yours."
          action={
        ...
        <TableCard>
          <thead>
            <tr>
              <SortableTh k="asset" sort={sort}>
                Asset
              </SortableTh>
              <SortableTh k="who" sort={sort}>
                Reserved by
              </SortableTh>
              <SortableTh k="from" sort={sort}>
                From
              </SortableTh>
              <SortableTh k="to" sort={sort}>
                To
              </SortableTh>
            ...
            {sort.sorted.map((r) => {
              ...
              return (
                <HoverRow key={r.id}>
                  ...
                  <td style={tdStyle}>
                    <Badge tone={tones[st]} dot pulse={st === "active"}>
                      {st}
                    </Badge>
                  </td>

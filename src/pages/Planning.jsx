      ...
      <Card padding="0" style={{ overflow: "hidden" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(7, 1fr)" }}>
          ...
          {cells.map((d, i) => {
            ...
            const _overdue = d ? open.filter((t) => t.due < new Date(year, month, d) && sameDay(t.due, d)) : [];
            ...
            return (
              ...
              >
                {d && (
                  <div
                    style={{
                      fontFamily: "var(--font-mono)",
                      fontSize: 11,
                      color: isToday ? "var(--accent-text)" : "var(--text-3)",
                      marginBottom: 6,
                    }}
                  >
                    {d}
                ...
                {dayTickets.slice(0, 3).map((t) => (
                  ...
                  >
                    <span
                      style={{ fontFamily: "var(--font-mono)", fontSize: 10, color: "var(--text-3)", flex: "0 0 auto" }}
                    >

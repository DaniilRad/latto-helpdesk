 ...
 */
export function IconButton({ children, size = "md", variant = "ghost", label, disabled = false, style = {}, ...rest }) {
  ...
  const base = {
    ...
    transition:
      "background var(--dur-fast) var(--ease), color var(--dur-fast) var(--ease), transform var(--dur-fast) var(--ease)",
